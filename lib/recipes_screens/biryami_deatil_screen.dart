...
class BiryaniDetailScreen extends StatelessWidget {
  const BiryaniDetailScreen({super.key});
                              ...
                              children: [
                                ...
                                Text('Directions:',
                                    style: AppWidget.healinTextstyle(
                                        screenWidth * 0.06)),
                                Text(
                                  'Cook chicken with spices, layer with rice, add saffron, steam for 15 mins.',
                                  style: TextStyle(fontSize: screenWidth * 0.045),
                                ),
